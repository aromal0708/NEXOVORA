    ...
    <div className="min-h-screen bg-primary">
      ...
      <section className="relative h-screen flex items-center justify-center bg-primary overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-accent/5 rounded-full blur-3xl float-animation" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-accent/5 rounded-full blur-2xl float-animation" style={{ animationDelay: '4s' }}></div>
        </div>

        <div className="relative z-10 text-center text-accent px-4 max-w-5xl mx-auto">
          <motion.div
          ...
          >
            <motion.img 
              ...
              alt="Nexovora Logo" 
              className="h-24 w-auto mx-auto rounded-xl shadow-white-glow cursor-pointer"
              whileHover={{ 
                scale: 1.3,
                rotateY: 30,
                rotateX: 15,
              ...
              style={{
                ...
                filter: "drop-shadow(0 20px 40px rgba(255, 255, 255, 0.2)) drop-shadow(0 10px 20px rgba(255, 255, 255, 0.15)) drop-shadow(0 0 30px rgba(255, 255, 255, 0.1))"
              }}
            />
          </motion.div>
          ...
          >
            <span className="gradient-text text-glow">Engineering Impact.</span>
            <br />
          ...
          >
            A next-gen tech company incubated in college, creating impactful digital solutions 
            in education, mobility, and infrastructure.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-highlight max-w-3xl mx-auto">
              Born from innovation and nurtured in academia, Nexovora represents the next generation 
              of technology companies. We're not just building products—we're crafting solutions 
              that matter.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="text-center p-6 glass-black rounded-xl hover:shadow-white-glow transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {products.map((product, index) => (
              <motion.div
                ...
                className="glass-white rounded-xl p-8 shadow-premium hover:shadow-white-glow transition-all duration-300"
              >
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-highlight mb-8">
              Join us in our mission to create impactful digital solutions that matter.
            </p>
